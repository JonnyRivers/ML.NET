...
namespace TaxiFareML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Jonny\Documents\GitHub\JonnyRivers\ML.NET\TaxiFare\taxi-fare-train.csv";
        private static string MODEL_FILEPATH = @"../../../../TaxiFareML.Model/MLModel.zip";
