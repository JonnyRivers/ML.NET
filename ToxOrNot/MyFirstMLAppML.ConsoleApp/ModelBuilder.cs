...
namespace MyFirstMLAppML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\Jonny\Documents\GitHub\JonnyRivers\ML.NET\MyFirstMLApp\wikipedia-detox-250-line-data.tsv.txt";
        private static string MODEL_FILEPATH = @"../../../../MyFirstMLAppML.Model/MLModel.zip";
